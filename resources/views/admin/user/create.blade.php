...
@section('content')
<div class="card">
	<form id="jq-validation-example-2" method="post" class="form-horizontal mt-4" action="{{ route('admin.user.store') }}">
		{{ csrf_field() }}
		...
		<div class="form-group row">
			<label class="col-sm-4 col-form-label text-sm-right" for="name">Senha</label>
			<div class="col-md-5 col-sm-8">
				<input type="text" class="form-control" id="password" name="password" placeholder="Senha" value="{{old('password')}}" required/>
			</div>
		</div>
